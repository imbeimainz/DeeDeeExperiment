...
more precisely contrasting the counts from naive macrophage to those
...
Other DEresus: [`IFNg_both`](IFNg_both.md),
[`IFNg_naive`](IFNg_naive.md), [`Salm_both`](Salm_both.md)
