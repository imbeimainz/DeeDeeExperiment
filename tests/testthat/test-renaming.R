test_that("renaming", {
  ...
  expect_equal(names(dea_info(dde_rename)), c(
  ...
  expect_equal(names(dea_info(dde3_rename)), c(
  ...
  expect_equal(
    fea_info(dde3_rename)[["ifngsalmo_vs_naive"]][["de_name"]],
    "IFNg_SalmvsNaive"
  )
  ...
  expect_equal(fea_names(fea_rename), c(
    "ifng_vs_naive",
    "ifngsalmo_vs_naive",
